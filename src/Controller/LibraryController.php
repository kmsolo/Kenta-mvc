...
class LibraryController extends AbstractController
{
    ...
    [
        ...
        'isbn' => '9789129723632',
        'description' => 'Den starkaste flickan i världen flyttar in i Villa Villekulla med sin apa och häst.',
    ],
    [
        'title' => 'Hobbiten',
        'author' => 'J.R.R. Tolkien',
        'isbn' => '9789113050300',
        'description' => 'Bilbo Secker dras med på äventyr av Gandalf och tretton dvärgar för att röva tillbaka en guldskatt från draken Smaug.',
    ],
];
